...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/savings/installment-savings-guide";
import "@/components/article.css";

const PAGE_URL = "https://moneydoc.kr/savings/installment-savings-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/savings/installment-savings-guide/" },
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "저축", item: "https://moneydoc.kr/savings/" },
    { "@type": "ListItem", position: 3, name: "적금·예금 이자", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/savings/">저축</a> › 적금·예금 이자
          </div>
