...
import { meta, faqLd, html, scriptKey } from "@/data/articles/government/unemployment-total-guide";

const PAGE_URL = "https://moneydoc.kr/unemployment/total/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/unemployment/total/" },
