...
import { meta, faqLd, html, scriptKey } from "@/data/articles/government/unemployment-eitc-guide";

const PAGE_URL = "https://moneydoc.kr/unemployment/eitc/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/unemployment/eitc/" },
