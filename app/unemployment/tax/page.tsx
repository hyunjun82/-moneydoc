...
import { meta, faqLd, html, scriptKey } from "@/data/articles/government/unemployment-tax-guide";

const PAGE_URL = "https://moneydoc.kr/unemployment/tax/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/unemployment/tax/" },
