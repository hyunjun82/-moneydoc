...
import { meta, faqLd, html, scriptKey } from "@/data/articles/government/unemployment-study-guide";

const PAGE_URL = "https://moneydoc.kr/unemployment/study/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/unemployment/study/" },
