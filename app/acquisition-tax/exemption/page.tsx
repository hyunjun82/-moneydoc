...
import { meta, faqLd, html, scriptKey } from "@/data/articles/realestate/acquisition-tax-exemption-guide";

const PAGE_URL = "https://moneydoc.kr/acquisition-tax/exemption/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/acquisition-tax/exemption/" },
