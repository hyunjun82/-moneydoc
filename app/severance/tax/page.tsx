...
import { meta, faqLd, html, scriptKey } from "@/data/articles/law/severance-tax-guide";

const PAGE_URL = "https://moneydoc.kr/severance/tax/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/severance/tax/" },
