...
const PAGE_URL = "https://moneydoc.kr/eitc/";
...
export default function Page() {
  return (
    <>
      ...
      <nav className="crumbs"><a href="/">홈</a><span className="sep">›</span><a href="/gov/">정부지원금</a><span className="sep">›</span><span>근로장려금 지급일·조회</span></nav>
