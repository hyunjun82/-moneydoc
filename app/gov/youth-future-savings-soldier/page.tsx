...
const PAGE_URL = "https://moneydoc.kr/gov/youth-future-savings-soldier/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/gov/youth-future-savings-soldier/" },
...
const breadcrumbLd = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [ { "@type": "ListItem", position: 1, name: "홈", item: "https://moneydoc.kr/" }, { "@type": "ListItem", position: 2, name: "정부지원금", item: "https://moneydoc.kr/gov/" }, { "@type": "ListItem", position: 3, name: "청년미래적금 군인 가입", item: PAGE_URL } ] };

export default function Page() {
  return (
    <>
      <Header active="government" />
      <nav className="crumbs"><a href="/">홈</a><span className="sep">›</span><a href="/gov/">정부지원금</a><span className="sep">›</span><a href="/gov/youth-future-savings-guide/">청년미래적금</a><span className="sep">›</span><span>군인 가입</span></nav>
