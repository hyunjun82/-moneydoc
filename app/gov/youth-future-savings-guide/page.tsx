...
const PAGE_URL = "https://moneydoc.kr/gov/youth-future-savings-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/gov/youth-future-savings-guide/" },
  openGraph: {
    type: "article",
    title: meta.title,
    description: meta.description,
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "정부지원금", item: "https://moneydoc.kr/gov/" },
