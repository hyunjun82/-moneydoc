...
import { meta, faqLd, html, scriptKey } from "@/data/articles/law/deposit-return-suit-guide";

const PAGE_URL = "https://moneydoc.kr/law/deposit-return-suit-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/law/deposit-return-suit-guide/" },
