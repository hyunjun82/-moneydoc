...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/loan/dsr-limit-guide";
import "@/components/article.css";

const PAGE_URL = "https://moneydoc.kr/loan/dsr-limit-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/loan/dsr-limit-guide/" },
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "대출", item: "https://moneydoc.kr/loan/" },
    { "@type": "ListItem", position: 3, name: "스트레스 DSR", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/loan/">대출</a> › 스트레스 DSR
          </div>
