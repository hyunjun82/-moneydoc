...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/realestate/transfer-tax-guide";
import "@/components/article.css";

const PAGE_URL = "https://moneydoc.kr/realestate/transfer-tax-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/realestate/transfer-tax-guide/" },
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "1세대 1주택 비과세", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/realestate/">부동산</a> › 1세대 1주택 비과세
          </div>
