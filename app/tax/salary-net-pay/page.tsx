...
export const metadata: Metadata = {
  title: "연봉 실수령액 계산기 — 2026 국세청 기준",
  description:
    "세전 연봉, 부양가족, 자녀 수만 입력하면 매월 통장에 들어오는 실수령액 자동 계산. 국세청 2026 간이세액표 + 4대보험 공식 요율 기반. 5개 케이스 검증 완료.",
...
export default function Page() {
  return (
    <CalculatorShell
      spec={spec}
      sourceBadge="국세청 2026 간이세액표 · 5케이스 검증 완료"
