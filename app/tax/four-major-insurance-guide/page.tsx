...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/tax/four-major-insurance-guide";
import "@/components/article.css";

const PAGE_URL = "https://moneydoc.kr/tax/four-major-insurance-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/tax/four-major-insurance-guide/" },
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "4대보험 요율", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/tax/">세금</a> › 4대보험 요율
          </div>
