...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/government/parental-leave-pay-guide";
import "@/components/article.css";

const PAGE_URL = "https://moneydoc.kr/government/parental-leave-pay-guide/";

export const metadata: Metadata = {
  title: meta.title,
  description: meta.description,
  alternates: { canonical: "/government/parental-leave-pay-guide/" },
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "육아휴직 급여", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/government/">정부지원금</a> › 육아휴직 급여
          </div>
