...
import { meta, faqLd, widgetKey, widgetHtml, htmlBefore, htmlAfter, asideHtml } from "@/data/articles/government/basic-pension-guide";
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "기초연금 수급 조건", item: PAGE_URL },
  ],
};
  ...
  return (
    <>
      ...
      <div className="md-article">
        <main>
          <div className="crumb">
            <a href="/">홈</a> › <a href="/government/">정부지원금</a> › 기초연금 수급 조건
          </div>
