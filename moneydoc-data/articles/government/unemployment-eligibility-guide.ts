...
<div class="v2-meta"><span>글 <a href="/about/">한결</a></span><span>·</span><span>2026년 9월 기준</span><span>·</span><span>7분</span><span class="v2-badge">고용보험법 수급 요건 원문 대조 · 2026-09-09</span></div>
...
<section class="v2-answer" aria-label="즉답">
  ...
  <div class="v2-chips" id="qchips" data-q='[{&quot;big&quot;:&quot;대체로 가능&quot;,&quot;unit&quot;:&quot;수급자격&quot;,&quot;sub&quot;:&quot;가입 180일과 나머지 조건을 채우면 돼요&quot;},{&quot;big&quot;:&quot;사유에 달림&quot;,&quot;unit&quot;:&quot;수급자격&quot;,&quot;sub&quot;:&quot;고용노동부령이 정한 정당한 사유면 인정돼요&quot;},{&quot;big&quot;:&quot;대체로 가능&quot;,&quot;unit&quot;:&quot;수급자격&quot;,&quot;sub&quot;:&quot;재계약을 거절한 사정에 따라 갈릴 수 있어요&quot;}]'><button type="button" data-i="0" aria-pressed="true">회사가 그만두라고 했어요</button><button type="button" data-i="1" aria-pressed="false">제가 그만뒀어요</button><button type="button" data-i="2" aria-pressed="false">계약이 끝났어요</button></div>
  <div class="v2-big" id="qnet">대체로 가능<small>수급자격</small></div>
  <div class="v2-sub" id="qsub">가입 180일과 나머지 조건을 채우면 돼요</div>
  <div class="v2-split">
    <div class="v2-box"><b>네 가지를 모두 채워야 해요</b><span>법은 요건을 모두 갖춘 경우에 지급한다고 정해요. 하나라도 빠지면 안 돼요</span></div>
    <div class="v2-box"><b>180일은 재직 일수가 아니에요</b><span>보수가 나간 날만 세요. 유급 주휴일도 들어가서 주 5일 근무자는 주 6일이 쌓여요</span></div>
  </div>
</section>
<!--CALC_START--><a class="v2-cta" href="/unemployment/calculator/">조건이 되면 얼마인지 계산해 보기</a><!--CALC_END-->
<details class="v2-toc"><summary>목차 (6개 질문)<span>열기</span></summary><ol><li><a href="#s1">실업급여 수급자격 4가지 조건은 무엇인가요</a></li><li><a href="#s2">고용보험 180일은 어떻게 채우나요</a></li><li><a href="#s3">이직 사유가 비자발적이어야 한다는 건 무슨 뜻인가요</a></li><li><a href="#s4">근로 의사와 재취업 노력은 어떻게 확인하나요</a></li><li><a href="#s5">4가지를 다 채웠는지 어디서 확인하나요</a></li><li><a href="#faq">자주 묻는 질문</a></li></ol></details>
<section class="v2-kk" aria-label="한눈에 보는 요약">
  <div class="v2-hd"><small>한눈에 보는 수급자격</small><b>핵심콕콕</b></div>
  <dl>
    <div class="v2-row"><dt>조건 1</dt><dd>기준기간 동안 피보험 단위기간이 합산 180일 이상</dd></div>
    <div class="v2-row"><dt>조건 2</dt><dd>근로 의사와 능력이 있는데도 취업하지 못한 상태</dd></div>
    <div class="v2-row"><dt>조건 3</dt><dd>이직 사유가 수급자격 제한 사유가 아닐 것</dd></div>
    <div class="v2-row"><dt>조건 4</dt><dd>재취업을 위한 노력을 적극적으로 할 것</dd></div>
    <div class="v2-row"><dt>기준기간</dt><dd>원칙은 이직일 이전 18개월</dd></div>
    <div class="v2-row"><dt>일용근로자</dt><dd>위 네 가지에 두 가지가 더 붙어요</dd></div>
  </dl>
</section>

<h2 id="s1">실업급여 수급자격 4가지 조건은 무엇인가요<small>고용보험법 제40조가 정한 네 가지</small></h2>
<p class="v2-lead"><span class="v2-ans">180일 가입, 취업하지 못한 상태, 이직 사유, 재취업 노력 네 가지예요.</span> 법은 이 요건을 모두 갖춘 경우에 지급한다고 정해요. 그래서 가입 기간이 아무리 길어도 이직 사유가 걸리면 안 되고, 사유가 깨끗해도 180일이 모자라면 안 돼요. 네 가지 뒤에 붙는 다섯째와 여섯째 조건은 마지막 이직 당시 일용근로자였던 사람에게만 해당해요.</p>
<div class="v2-tree" id="eligTree" data-tree='{&quot;ok&quot;:{&quot;title&quot;:&quot;수급자격 조건을 채웠어요&quot;,&quot;text&quot;:&quot; 고용센터에 수급자격 인정을 신청하면 돼요. 인정 여부는 고용센터가 결정해요.&quot;},&quot;no&quot;:[{&quot;title&quot;:&quot;아직 180일이 모자라요&quot;,&quot;text&quot;:&quot; 전 직장 기간이 합산될 수 있어요. 고용보험 홈페이지에서 내 단위기간을 먼저 확인해 보세요.&quot;},{&quot;title&quot;:&quot;지금은 대상이 아니에요&quot;,&quot;text&quot;:&quot; 아파서 일할 수 없는 상태라면 수급기간을 미루는 신고를 먼저 하세요.&quot;},{&quot;title&quot;:&quot;수급자격이 제한돼요&quot;,&quot;text&quot;:&quot; 다만 고용노동부령이 정한 정당한 사유에 해당하면 인정될 수 있어요.&quot;},{&quot;title&quot;:&quot;지급이 이어지지 않아요&quot;,&quot;text&quot;:&quot; 활동을 신고하지 않으면 그 회차는 인정되지 않아요.&quot;}]}'>
  <div class="v2-q"><div><b>이직 전 18개월 동안 피보험 단위기간이 180일 이상인가요?</b><small>보수가 나간 날만 세요. 유급 주휴일을 더하면 주 5일 근무자는 7개월 안팎이 걸려요</small></div><div class="v2-sw"><button type="button" data-q="0" data-v="1" aria-pressed="true">예</button><button type="button" data-q="0" data-v="0" aria-pressed="false">아니오</button></div></div>
  <div class="v2-q"><div><b>지금 일하지 않고 있고, 일할 의사와 능력이 있나요?</b><small>영리를 목적으로 사업을 하는 경우도 취업으로 봐요</small></div><div class="v2-sw"><button type="button" data-q="1" data-v="1" aria-pressed="true">예</button><button type="button" data-q="1" data-v="0" aria-pressed="false">아니오</button></div></div>
  <div class="v2-q"><div><b>중대한 귀책사유로 해고되거나 전직·자영업을 하려고 그만둔 게 아닌가요?</b><small>이 두 가지에 해당하면 법이 수급자격이 없는 것으로 봐요</small></div><div class="v2-sw"><button type="button" data-q="2" data-v="1" aria-pressed="true">예</button><button type="button" data-q="2" data-v="0" aria-pressed="false">아니오</button></div></div>
  <div class="v2-q"><div><b>재취업을 위한 노력을 할 수 있나요?</b><small>실업인정일마다 구직활동을 신고해야 그 회차 급여가 나와요</small></div><div class="v2-sw"><button type="button" data-q="3" data-v="1" aria-pressed="true">예</button><button type="button" data-q="3" data-v="0" aria-pressed="false">아니오</button></div></div>
...
<p class="v2-lead"><span class="v2-ans">재직 일수가 아니라 보수 지급의 기초가 된 날을 합해서 180일이에요.</span> 보수가 나가지 않는 날은 빠지고, 유급으로 처리되는 주휴일은 들어가요. 그래서 주 5일 근무자는 주 6일씩 쌓여 달력으로 7개월 안팎을 다녀야 채워져요. 세는 구간은 기준기간이고, 원칙은 이직일 이전 18개월이에요.</p>
<p><span class="v2-ans">기준기간이 늘어나는 경우도 있어요.</span> 보수를 오래 받지 못했거나 아주 짧게 일한 사람은 18개월로 자르면 불리해서, 법이 세는 구간을 늘려 줘요.</p>
<div class="v2-tbl v2-text"><table><caption>상황별 기준기간</caption><thead><tr><th>상황</th><th>기준기간</th></tr></thead><tbody>
<tr><th scope="row">원칙</th><td data-l="기준기간">이직일 이전 18개월</td></tr>
<tr><th scope="row">질병·부상 등으로 30일 이상 보수를 못 받은 경우</th><td data-l="기준기간">18개월에 그 일수를 더한 기간 (최대 3년)</td></tr>
...
<p><span class="v2-ans">중대한 귀책사유는 세 가지로 정해져 있어요.</span> 형법이나 직무 관련 법률을 위반해 금고 이상의 형을 선고받은 경우가 하나예요. 사업에 막대한 지장을 주거나 재산상 손해를 끼친 경우가 둘이에요. 정당한 사유 없이 근로계약이나 취업규칙을 위반해 장기간 무단 결근한 경우가 셋이에요.</p>
<p><span class="v2-ans">자기 사정으로 그만둔 경우도 제한 사유예요.</span> 전직이나 자영업을 하려고 그만둔 경우가 대표적이에요. 중대한 귀책사유가 있는 사람이 해고되지 않고 사업주의 권고로 그만둔 경우도 여기에 들어가요.</p>
<div class="v2-note"><b>사유는 이직확인서에 코드로 적혀요</b> 회사가 적어 낸 코드가 실제와 다르면 수급자격 판단이 달라져요. 신청 전에 어떤 코드로 신고됐는지 확인하는 게 안전해요.</div>

<h2 id="s4">근로 의사와 재취업 노력은 어떻게 확인하나요<small>실업인정일마다 활동을 신고해요</small></h2>
<p class="v2-lead"><span class="v2-ans">고용센터가 지정한 실업인정일에 재취업 활동을 신고하는 것으로 확인해요.</span> 두 번째 조건인 취업하지 못한 상태는 신청 시점만 보는 게 아니라 받는 동안 계속 유지돼야 해요. 영리를 목적으로 사업을 하는 경우도 취업으로 보기 때문에, 사업자등록을 냈다면 그 사실을 신고해야 해요.</p>
<p><span class="v2-ans">노력을 하지 않으면 그 회차가 인정되지 않아요.</span> 수급자격이 한 번 인정됐다고 끝까지 자동으로 나오는 게 아니에요. 실업인정을 받은 날에 대해서만 지급되기 때문에, 활동을 하지 않거나 신고하지 않으면 그 기간은 빠져요. 소개된 직업이나 훈련을 정당한 사유 없이 거부해도 지급이 정지될 수 있어요.</p>
...
<div class="v2-faqs">
<details class="v2-faq" open><summary><i>Q</i><span>실업급여 수급자격 조건은 몇 가지인가요?</span></summary><div><i>A</i><p>일반 근로자는 네 가지예요. 180일 이상 가입, 취업하지 못한 상태, 이직 사유가 제한 사유가 아닐 것, 재취업 노력이에요. 마지막 이직 당시 일용근로자였다면 두 가지가 더 붙어요.</p></div></details>
<details class="v2-faq"><summary><i>Q</i><span>180일은 다닌 날을 세나요?</span></summary><div><i>A</i><p>아니에요. 보수가 나간 날만 합해서 세요. 유급 주휴일이 들어가서 주 5일 근무자는 달력으로 7개월 안팎이 걸려요.</p></div></details>
...
<li>180일은 다닌 날이 아니라 보수 지급의 기초가 된 날을 세요.</li>
<li>자발적 퇴사도 정당한 사유면 인정돼요. 법은 제한 사유만 정해 놓았어요.</li>
<li>수급자격은 고용센터가 인정해야 확정돼요. 애매하면 신청해 보세요.</li>
</ul></section>
<a class="v2-cta" href="/unemployment/calculator/">조건이 되면 얼마인지 계산해 보기</a>
<h2 id="src">출처</h2>
<div class="v2-src">
...
export const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "실업급여 수급자격 조건은 몇 가지인가요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "일반 근로자는 네 가지예요. 180일 이상 가입, 취업하지 못한 상태, 이직 사유가 제한 사유가 아닐 것, 재취업 노력이에요. 마지막 이직 당시 일용근로자였다면 두 가지가 더 붙어요."
      }
    },
    {
      "@type": "Question",
      "name": "180일은 다닌 날을 세나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "아니에요. 보수가 나간 날만 합해서 세요. 유급 주휴일이 들어가서 주 5일 근무자는 달력으로 7개월 안팎이 걸려요."
      }
    },
    {
      "@type": "Question",
      "name": "자발적으로 그만두면 무조건 안 되나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "아니에요. 법은 정해진 제한 사유에 해당하지 않을 것이라고 정해요. 고용노동부령이 정한 정당한 사유에 해당하면 스스로 그만둬도 인정돼요."
      }
    },
    {
      "@type": "Question",
      "name": "180일을 세는 기간은 얼마인가요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "원칙은 이직일 이전 18개월이에요. 질병이나 부상으로 30일 이상 보수를 못 받았으면 그 일수를 더해 최대 3년까지, 주 15시간 미만 근로가 조건에 맞으면 24개월이 돼요."
      }
    },
    {
      "@type": "Question",
      "name": "전에 실업급여를 받은 적이 있으면 어떻게 되나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "그때 구직급여와 관련된 자격 상실일 이전의 단위기간은 세지 않아요. 그 뒤로 다시 180일을 채워야 해요."
      }
    },
    {
      "@type": "Question",
...
export const landing = {
  ...
  "quick": [
    ...
    },
    {
      ...
      "big": "대체로 가능",
      "unit": "수급자격",
      "sub": "재계약을 거절한 사정에 따라 갈릴 수 있어요",
      "selected": false
    }
  ],
  "boxes": [
    {
      "title": "네 가지를 모두 채워야 해요",
      "text": "법은 요건을 모두 갖춘 경우에 지급한다고 정해요. 하나라도 빠지면 안 돼요"
    },
    {
      "title": "180일은 재직 일수가 아니에요",
      "text": "보수가 나간 날만 세요. 유급 주휴일도 들어가서 주 5일 근무자는 주 6일이 쌓여요"
    }
  ],
  "keyPoints": {
    "title": "한눈에 보는 수급자격",
  ...
  "sections": [
    {
      "id": "s1",
      "h2": "실업급여 수급자격 4가지 조건은 무엇인가요",
      "sub": "고용보험법 제40조가 정한 네 가지"
    },
    {
      "id": "s2",
      "h2": "고용보험 180일은 어떻게 채우나요",
      "sub": "보수 지급의 기초가 된 날을 합산해요"
    },
    {
      "id": "s3",
      "h2": "이직 사유가 비자발적이어야 한다는 건 무슨 뜻인가요",
      "sub": "법이 정한 제한 사유에 걸리지 않으면 돼요"
    },
    {
      "id": "s4",
      "h2": "근로 의사와 재취업 노력은 어떻게 확인하나요",
      "sub": "실업인정일마다 활동을 신고해요"
    },
    {
      "id": "s5",
      "h2": "4가지를 다 채웠는지 어디서 확인하나요",
      "sub": "단위기간은 고용보험, 인정은 고용센터"
    }
  ],
  "faq": [
    {
      "q": "실업급여 수급자격 조건은 몇 가지인가요?",
      "a": "일반 근로자는 네 가지예요. 180일 이상 가입, 취업하지 못한 상태, 이직 사유가 제한 사유가 아닐 것, 재취업 노력이에요. 마지막 이직 당시 일용근로자였다면 두 가지가 더 붙어요."
    },
    {
      "q": "180일은 다닌 날을 세나요?",
      "a": "아니에요. 보수가 나간 날만 합해서 세요. 유급 주휴일이 들어가서 주 5일 근무자는 달력으로 7개월 안팎이 걸려요."
    },
    {
      "q": "자발적으로 그만두면 무조건 안 되나요?",
      "a": "아니에요. 법은 정해진 제한 사유에 해당하지 않을 것이라고 정해요. 고용노동부령이 정한 정당한 사유에 해당하면 스스로 그만둬도 인정돼요."
    },
    {
      "q": "180일을 세는 기간은 얼마인가요?",
      "a": "원칙은 이직일 이전 18개월이에요. 질병이나 부상으로 30일 이상 보수를 못 받았으면 그 일수를 더해 최대 3년까지, 주 15시간 미만 근로가 조건에 맞으면 24개월이 돼요."
    },
    {
      "q": "전에 실업급여를 받은 적이 있으면 어떻게 되나요?",
      "a": "그때 구직급여와 관련된 자격 상실일 이전의 단위기간은 세지 않아요. 그 뒤로 다시 180일을 채워야 해요."
    },
    {
