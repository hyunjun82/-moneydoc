...
// 디자인: 허브와 동일한 .cardnews 스코프. 본문은 정적 HTML. 사실은 실측 출처·검증 산식만.

export const meta = {
  title: "군인도 청년미래적금 가입되나요? 군장병급여만 있어도 OK",
  description:
    "군인도 청년미래적금 가입 가능. 직전연도 소득 없는 병사도 군장병급여만 있으면 OK. 훈련소 내 비대면 가입, 장병내일준비적금·장기간부도약적금 중복가입, 군인 만기 수령액(일반형 6%), 군필 나이 만 40세까지.",
  ogImage:
...
<article class="wrap">
    ...
    <details class="toc" open>
      ...
      <nav class="toc-nav">
        ...
        <a href="#sec-payout">군인 만기 수령액 (월 납입별)</a>
        <a href="#sec-overlap">군 적금과 중복가입</a>
        <a href="#sec-age">군필자 나이 (병역기간 차감)</a>
        <a href="#sec-apply">군인 신청 방법 (3단계)</a>
    ...
    <section class="card" id="sec-why">
      ...
      <p class="secteaser">일반 가입자는 직전연도(2025년) 국세청 소득이 있어야 해요. 그런데 병사는 직전연도 소득이 안 잡히는 경우가 많죠. 정부가 군인을 위해 이걸 예외로 인정했습니다.</p>
      <ul class="docs">
        ...
        <li><span>사관생도·사회복무요원 등 <b>복무 중 급여</b>나 육아휴직급여(수당)도 같은 방식으로 인정됩니다.</span></li>
    ...
    <section class="card" id="sec-bootcamp">
      ...
      <ul class="docs">
        ...
        <li><span>전역·자대배치 전이라도 본인 명의로 신청하면 돼요.</span></li>
      </ul>
    ...
    <section class="card" id="sec-type">
      ...
      <ul class="docs">
        <li><span><b>일반형(6%)</b> — 소득요건(총급여 7,500만 이하 등)만 충족하면 적용. 대부분의 장병이 여기예요. 매월 납입금의 6%를 정부가 매칭해요.</span></li>
    ...
    <section class="card" id="sec-overlap">
      ...
      <ul class="docs">
        ...
        <li><span>단, <b>청년도약계좌와는 중복 불가</b> — 청년미래적금과 둘 중 하나만 가능해요.</span></li>
      </ul>
    ...
    <section class="card" id="sec-age">
      ...
      <ul class="docs">
        ...
        <li><span>현역병·상근예비역·사회복무요원·대체복무 등 병역 이행 기간이 인정돼요.</span></li>
      </ul>
    </section>
    ...
    <section class="card" id="sec-apply">
      ...
      <div class="steps">
        <div class="st"><span class="sn">1</span><div class="sb"><b>취급은행 앱 또는 서민금융진흥원에서 신청</b>취급은행 앱이나 <a href="https://fill4young.kinfa.or.kr/yfs/main">서민금융진흥원 청년금융</a>에서 비대면으로 신청해요. 훈련소 안에서도 가능.</div></div>
        <div class="st"><span class="sn">2</span><div class="sb"><b>소득·요건 자동 심사</b>서민금융진흥원이 군장병급여 등 소득과 가구 요건을 확인하고 <b>유형을 자동으로 정해</b> 알려줘요. 군인은 대부분 일반형(6%).</div></div>
        <div class="st"><span class="sn">3</span><div class="sb"><b>적금 개설 후 납입 시작</b>승인되면 계좌를 만들고 <b>월 최대 50만 원</b>을 자유롭게 넣으면 끝. 3년 뒤 원금 + 정부기여금 + 비과세 이자를 받아요.</div></div>
      </div>
    </section>
