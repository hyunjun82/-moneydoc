...
<div class="v2-meta"><span>글 <a href="/about/">한결</a></span><span>·</span><span>2026년 9월 기준</span><span>·</span><span>6분</span><span class="v2-badge">고용보험법 지급일 규정 원문 대조 · 2026-09-15</span></div>
...
<details class="v2-toc"><summary>목차 (6개 질문)<span>열기</span></summary><ol><li><a href="#s1">실업인정 후 며칠 만에 지급되나요</a></li><li><a href="#s2">입금 시간은 언제인가요</a></li><li><a href="#s3">지급일이 주말이나 공휴일이면 어떻게 되나요</a></li><li><a href="#s4">회차별 입금 날짜는 어디서 보나요</a></li><li><a href="#s5">돈이 안 들어오면 어디에 문의하나요</a></li><li><a href="#faq">자주 묻는 질문</a></li></ol></details>
<section class="v2-kk" aria-label="한눈에 보는 요약">
  <div class="v2-hd"><small>한눈에 보는 지급일</small><b>핵심콕콕</b></div>
  <dl>
    <div class="v2-row"><dt>지급 기준</dt><dd>실업의 인정을 받은 일수분</dd></div>
    <div class="v2-row"><dt>지급일 통지</dt><dd>고용센터가 지급할 날짜를 정해 알려 줘요</dd></div>
    <div class="v2-row"><dt>첫 회차</dt><dd>대기기간 7일이 빠져 7일치</dd></div>
    <div class="v2-row"><dt>2차 이후</dt><dd>인정일 간격만큼의 일수분</dd></div>
    <div class="v2-row"><dt>인정일 간격</dt><dd>1차 14일, 2·3차 28일, 4차 이후 7~28일</dd></div>
    <div class="v2-row"><dt>안 들어올 때</dt><dd>실업인정 여부와 계좌를 먼저 확인해요</dd></div>
  </dl>
</section>
...
<div class="v2-tl" aria-label="실업 신고부터 첫 입금까지">
  ...
  <div class="v2-go"><i>14일</i><b>1차 실업인정일</b><span>지정된 날에 나가 재취업활동을 신고하고 인정을 받아요</span><em>출석 필수</em></div>
...
<p><span class="v2-ans">계좌가 잘못되어 있으면 늦어져요.</span> 신청할 때 등록한 본인 명의 계좌로 들어와요. 계좌를 바꿨거나 해지했다면 지급이 막히니 미리 변경해 두세요.</p>
<div class="v2-note"><b>지급일은 수급자격증으로 확인하세요</b> 실업인정을 받을 때 다음 인정일과 함께 안내받아요. 헷갈리면 수급자격증 기재를 먼저 보세요.</div>

<h2 id="s3">지급일이 주말이나 공휴일이면 어떻게 되나요<small>은행 영업일에 처리돼요</small></h2>
<p class="v2-lead"><span class="v2-ans">계좌 입금은 은행 처리를 거치기 때문에 영업일 기준으로 움직여요.</span> 실업인정일 자체가 주말이나 공휴일로 잡히지는 않아요. 다만 연휴가 끼면 처리가 하루 이틀 밀릴 수 있어요. 이런 경우는 지급이 취소된 게 아니라 순서가 밀린 거예요.</p>
<p><span class="v2-ans">인정일이 공휴일이면 미리 안내해요.</span> 담당직원이 다음 인정일을 지정하면서 알려 주기 때문에 그때 확인하면 돼요. 사정이 생겨 그날 못 가게 되면 변경 신청을 먼저 알아보세요.</p>
<div class="v2-note"><b>못 가면 그 회차가 통째로 빠져요</b> 지정된 날에 본인이 출석하지 않으면 그 실업인정대상기간 전부가 인정되지 않아요. 지급이 밀리는 게 아니라 없어져요.</div>

<h2 id="s4">회차별 입금 날짜는 어디서 보나요<small>고용보험 홈페이지와 수급자격증</small></h2>
...
<h2 id="s5">돈이 안 들어오면 어디에 문의하나요<small>인정 여부부터 확인해요</small></h2>
<p class="v2-lead"><span class="v2-ans">실업인정이 났는지부터 확인하고, 인정됐는데 안 들어왔다면 관할 고용센터에 문의해요.</span> 가장 흔한 이유가 인정이 나지 않은 경우예요. 활동 신고가 부족했거나 자료가 확인되지 않아 보류된 상태일 수 있어요. 이때는 급여가 지급되지 않는 게 맞아요.</p>
<p><span class="v2-ans">취업 사실을 신고한 회차는 그만큼 빠져요.</span> 일한 날은 실업으로 인정되지 않기 때문에 그 날치가 빠진 금액이 들어와요. 예상보다 적다면 신고한 일수를 먼저 확인해 보세요.</p>
<div class="v2-tbl v2-text"><table><caption>안 들어올 때 확인 순서</caption><thead><tr><th>순서</th><th>확인할 것</th></tr></thead><tbody>
<tr><th scope="row">1</th><td data-l="확인할 것">이번 회차 실업인정이 처리됐는지</td></tr>
<tr><th scope="row">2</th><td data-l="확인할 것">취업이나 소득을 신고한 날이 있는지</td></tr>
<tr><th scope="row">3</th><td data-l="확인할 것">등록한 계좌가 정상인지</td></tr>
...
<b>정부 도구</b>고용보험 홈페이지의 지급 내역 화면에서 회차별 일수와 금액을 확인했어요 (2026-09-15 확인).
</div>
...
export const faqLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "대기기간 7일이 빠지기 때문이에요. 1차는 7일치가 나와요."
      }
    },
    {
      "@type": "Question",
      "name": "회차마다 금액이 다른 이유는요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "하루 금액이 바뀐 게 아니라 인정된 날수가 달라서예요. 4차부터는 인정일 간격이 7일에서 28일 사이라 더 그래요."
      }
    },
    {
      "@type": "Question",
      "name": "지급일이 공휴일이면 어떻게 되나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "은행 처리를 거치기 때문에 영업일 기준으로 하루 이틀 밀릴 수 있어요."
      }
    },
    {
      "@type": "Question",
...
export const landing = {
  "hero": {
    ...
    "foot": "고용보험법 지급일 규정 원문 대조 · 2026-09-15 검증",
    "card": {
      "label": "보통 언제 들어오나",
      "big": "다음 날",
      "unit": "실업인정 뒤",
  ...
  "badge": "고용보험법 지급일 규정 원문 대조 · 2026-09-15",
  "basis": "2026년 9월 기준",
  "readMinutes": 6,
  "quick": [
    {
      ...
      "big": "7일치",
      "unit": "지급",
      "sub": "대기기간 7일이 빠져서 약 462,336원이에요",
      "selected": true
    },
    {
      "chip": "2차 이후예요",
  ...
  "keyPoints": {
    ...
    "rows": [
      ...
      [
        "인정일 간격",
        "1차 14일, 2·3차 28일, 4차 이후 7~28일"
      ],
      [
        "안 들어올 때",
        "실업인정 여부와 계좌를 먼저 확인해요"
      ]
    ]
  },
  "sections": [
    {
      "id": "s1",
      "h2": "실업인정 후 며칠 만에 지급되나요",
      "sub": "인정을 받아야 지급이 시작돼요"
    },
    {
      "id": "s2",
      "h2": "입금 시간은 언제인가요",
    ...
    {
      "id": "s3",
      "h2": "지급일이 주말이나 공휴일이면 어떻게 되나요",
      "sub": "은행 영업일에 처리돼요"
    },
    {
      "id": "s4",
      "h2": "회차별 입금 날짜는 어디서 보나요",
      "sub": "고용보험 홈페이지와 수급자격증"
    },
    {
      "id": "s5",
      "h2": "돈이 안 들어오면 어디에 문의하나요",
      "sub": "인정 여부부터 확인해요"
    }
  ],
  "faq": [
    ...
    {
      "q": "첫 회차가 왜 적나요?",
      "a": "대기기간 7일이 빠지기 때문이에요. 1차는 7일치가 나와요."
    },
    {
      "q": "회차마다 금액이 다른 이유는요?",
      "a": "하루 금액이 바뀐 게 아니라 인정된 날수가 달라서예요. 4차부터는 인정일 간격이 7일에서 28일 사이라 더 그래요."
    },
    {
      "q": "지급일이 공휴일이면 어떻게 되나요?",
      "a": "은행 처리를 거치기 때문에 영업일 기준으로 하루 이틀 밀릴 수 있어요."
    },
    {
