...
<!--CALC_START--><a class="v2-cta" href="/parental-leave/calculator/">육아휴직 급여 계산기 바로가기</a><!--CALC_END-->
...
<div class="v2-tips">
  <div><b>휴직 기간도 근속으로 쳐요</b>퇴직금과 연차를 셀 때 그대로 포함돼요. 퇴직금과 연차 계산에서 불이익이 없어요.</div>
...
<a class="v2-cta" href="/parental-leave/calculator/">육아휴직 급여 계산기 바로가기</a>
<h2 id="src">출처</h2>
<div class="v2-src">
...
export const landing = {
  "hero": {
    ...
    "alt": "육아휴직 급여. 통상임금 300만원이면 12개월 동안 23,100,000원"
  },
  "calc": {
    "href": "/parental-leave/calculator/",
    "label": "육아휴직 급여 계산기 바로가기"
  },
  "badge": "고용보험법 시행령 지급액 기준과 1원 단위 일치 · 2026-09-02",
  "basis": "2026년 9월 기준",
  "readMinutes": 7,
  "quick": [
    {
      ...
      "big": "21,600,000원",
      "unit": "12개월 합계",
      "sub": "첫 3개월 2,000,000원 · 7개월째부터 1,600,000원",
      "selected": false
    },
    {
      "chip": "300만원",
      "big": "23,100,000원",
      "unit": "12개월 합계",
      "sub": "첫 3개월 2,500,000원 · 7개월째부터 1,600,000원",
      "selected": true
    },
    {
      "chip": "400만원",
  ...
  "boxes": [
    {
      "title": "고용보험 180일이 필요해요",
      "text": "육아휴직을 시작하기 전 피보험 단위기간이 합쳐서 180일 이상이어야 해요"
    },
    {
      "title": "기간은 1년, 조건 맞으면 1년 6개월",
      "text": "부모가 각각 3개월 이상 쓰면 6개월을 더 쓸 수 있어 9,600,000원을 더 받아요"
    }
  ],
  "keyPoints": {
    ...
    "rows": [
      ...
      [
        "고용보험 요건",
        "육아휴직 시작 전 피보험 단위기간 합산 180일 이상"
      ],
      [
        "기간",
        "1년 이내. 조건을 채우면 6개월을 더 써서 1년 6개월"
      ],
      [
        "1~3개월",
        "통상임금 전액. 상한 2,500,000원, 하한 700,000원"
      ],
      [
        "4~6개월",
        "통상임금 전액. 상한 2,000,000원"
      ],
      [
        "7개월째부터",
        "통상임금의 80%. 상한 1,600,000원"
      ],
      [
        "300만원 12개월",
        "합계 23,100,000원"
  ...
  "sections": [
    {
      "id": "s1",
      "h2": "육아휴직 조건, 누가 얼마나 쓸 수 있나요",
      "sub": "자녀 나이와 고용보험 가입 기간을 봐요"
    },
    {
      "id": "s2",
      "h2": "육아휴직 급여, 월마다 얼마 나오나요",
      "sub": "기간이 지날수록 상한이 낮아져요"
    },
    {
      "id": "s3",
      "h2": "6+6 부모육아휴직제는 얼마나 더 받나요",
      "sub": "부모가 함께 쓰면 상한이 크게 올라가요"
    },
    {
      "id": "s4",
      "h2": "육아휴직 급여 신청 방법은 어떻게 되나요",
      "sub": "고용보험 홈페이지나 고용센터"
    },
    {
      "id": "s5",
      "h2": "복직 후와 육아기 근로시간 단축은 어떻게 되나요",
      "sub": "전일 휴직 대신 시간을 줄일 수도 있어요"
    }
  ],
  "faq": [
    {
      "q": "육아휴직 급여는 얼마 받나요?",
      "a": "통상임금 300만원이면 첫 3개월 월 2,500,000원, 12개월 합계 <b>23,100,000원</b>이에요."
    },
    {
      "q": "육아휴직 급여 상한은 얼마인가요?",
      "a": "1~3개월은 2,500,000원, 4~6개월은 2,000,000원, 7개월째부터는 1,600,000원이에요. 하한은 700,000원이에요."
    },
    {
      "q": "육아휴직 조건이 어떻게 되나요?",
      "a": "만 8세 이하 또는 초등학교 2학년 이하 자녀를 키우면 쓸 수 있어요. 급여는 고용보험 피보험 단위기간 180일 이상이어야 받아요."
    },
    {
      "q": "육아휴직을 1년 6개월 쓸 수 있나요?",
      "a": "같은 자녀에 대해 부모가 각각 3개월 이상 썼거나 한부모, 장애아동 부모면 6개월을 더 쓸 수 있어요. 통상임금 300만원이면 9,600,000원을 더 받아요."
    },
    {
      "q": "6+6 부모육아휴직제가 뭔가요?",
      "a": "자녀 출생 후 18개월 안에 부모가 모두 육아휴직을 쓰면 첫 6개월 상한이 250만원에서 450만원까지 올라가는 제도예요."
    },
    {
      "q": "육아휴직 급여 신청 방법은 어떻게 되나요?",
      "a": "휴직 시작 1개월 뒤부터 고용보험 홈페이지나 고용센터에서 신청해요. 끝난 날 이후 12개월 이내에 내야 해요."
    },
    {
      "q": "육아휴직 기간도 근속에 들어가나요?",
      "a": "들어가요. 퇴직금과 연차 계산에서 불이익이 없고, 복직 후에는 같은 업무나 같은 수준의 임금을 주는 자리로 돌아가야 해요."
    }
  ],
  "related": [
    {
