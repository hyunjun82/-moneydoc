...
export const meta = {
  ...
  description: "월급별로 실업급여 하루 얼마를 받는지 표로 정리했어요. 월 180만만원이든 600만만원이든 하루 차이는 2,052원뿐이에요. 상한과 하한에 걸리는 지점을 함께 봤어요.",
  ...
  imageAlt: "월급별 실업급여 1일 수령액 표. 월 300만만원이면 하루 66,048원",
};

export const scriptKey = "unemployment-by-salary-guide";

export const html = `<h1>월급별 실업급여 1일 수령액 표, 내 월급이면 얼마인가요</h1>
...
<img class="v2-hero" src="/og/unemployment-by-salary-guide.png" width="1200" height="630" alt="월급별 실업급여 1일 수령액 표. 월 300만만원이면 하루 66,048원">
...
<section class="v2-answer" aria-label="즉답">
  ...
  <div class="v2-chips" id="qchips" data-q='[{&quot;big&quot;:&quot;66,048원&quot;,&quot;unit&quot;:&quot;하루&quot;,&quot;sub&quot;:&quot;하한액이 적용돼요&quot;},{&quot;big&quot;:&quot;66,048원&quot;,&quot;unit&quot;:&quot;하루&quot;,&quot;sub&quot;:&quot;60퍼센트로는 60,000원이라 하한액이 적용돼요&quot;},{&quot;big&quot;:&quot;68,100원&quot;,&quot;unit&quot;:&quot;하루&quot;,&quot;sub&quot;:&quot;상한액이 적용돼요&quot;}]'><button type="button" data-i="0" aria-pressed="true">월 200만만원</button><button type="button" data-i="1" aria-pressed="false">월 300만만원</button><button type="button" data-i="2" aria-pressed="false">월 500만만원</button></div>
...
<section class="v2-kk" aria-label="한눈에 보는 요약">
  ...
  <dl>
    ...
    <div class="v2-row"><dt>월 300만만원이면</dt><dd>하루 66,048원</dd></div>
...
<div class="v2-note"><b>통상임금이 더 크면 그쪽을 써요</b> 산정한 평균임금이 통상임금보다 적으면 통상임금을 기초일액으로 해요. 마지막 이직 당시 일용근로자였다면 이 규정은 적용되지 않아요.</div>

<h2 id="s2">월급별 1일 수령액 표는 어떻게 되나요<small>구간별로 정리했어요</small></h2>
<p class="v2-lead"><span class="v2-ans">월 180만만원부터 600만만원까지 하루 지급액을 계산했어요.</span> 표의 60퍼센트 값이 하한액보다 낮으면 하한액이 적용되고, 상한을 넘으면 상한액이 적용돼요. 어느 구간에서 갈리는지 표에서 바로 보여요.</p>
...
<tr><th scope="row">180만만원</th><td>36,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">200만만원</th><td>40,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">220만만원</th><td>44,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">250만만원</th><td>50,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">280만만원</th><td>56,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr class="v2-hi"><th scope="row">300만만원</th><td>60,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">330만만원</th><td>66,000원</td><td class="v2-net">66,048원</td><td>1,981,440원</td><td>하한액</td></tr>
<tr><th scope="row">360만만원</th><td>72,000원</td><td class="v2-net">68,100원</td><td>2,043,000원</td><td>상한액</td></tr>
<tr><th scope="row">400만만원</th><td>80,000원</td><td class="v2-net">68,100원</td><td>2,043,000원</td><td>상한액</td></tr>
<tr><th scope="row">450만만원</th><td>90,000원</td><td class="v2-net">68,100원</td><td>2,043,000원</td><td>상한액</td></tr>
<tr><th scope="row">500만만원</th><td>100,000원</td><td class="v2-net">68,100원</td><td>2,043,000원</td><td>상한액</td></tr>
<tr><th scope="row">600만만원</th><td>120,000원</td><td class="v2-net">68,100원</td><td>2,043,000원</td><td>상한액</td></tr>
</tbody></table></div>
<p class="v2-fn">구직급여일액은 기초일액의 100분의 60이고, 그 값이 최저구직급여일액보다 낮으면 최저구직급여일액을 지급해요. 30일 환산은 이해를 돕기 위한 값이고 실제로는 인정된 날수만큼 지급돼요.</p>
<div class="v2-note"><b>표에 없는 월급은 계산기로 보세요</b> 평균임금과 가입기간, 나이를 넣으면 하루 금액과 소정급여일수, 총액이 함께 나와요.</div>
...
<p><span class="v2-ans">그래서 고소득일수록 대체율이 낮아져요.</span> 월 400만만원을 받던 사람도 월 600만만원을 받던 사람도 하루 금액이 같아요. 실업급여는 생활을 최소한 받쳐 주는 제도라 위쪽을 막아 둔 거예요.</p>
...
<tr><th scope="row">이직 전 평균임금</th><td data-l="어디서 보나요">회사가 낸 이직확인서</td></tr>
...
<details class="v2-faq"><summary><i>Q</i><span>월급이 두 배면 실업급여도 두 배인가요?</span></summary><div><i>A</i><p>아니에요. 월 180만만원과 600만만원의 하루 차이가 2,052원뿐이에요.</p></div></details>
...
<li>월 180만만원과 600만만원의 하루 차이가 2,052원뿐이에요.</li>
...
export const faqLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "아니에요. 월 180만만원과 600만만원의 하루 차이가 2,052원뿐이에요."
      }
    },
    {
      "@type": "Question",
...
export const landing = {
  "hero": {
    ...
    "line2": "내 월급이면 얼마인가요",
    "sub1": "월 180만만원과 600만만원의 하루 차이가 2,052원이에요",
    ...
    "alt": "월급별 실업급여 1일 수령액 표. 월 300만만원이면 하루 66,048원"
  },
  "calc": {
  ...
  "faq": [
    ...
    },
    {
      ...
      "a": "아니에요. 월 180만만원과 600만만원의 하루 차이가 2,052원뿐이에요."
    },
    {
