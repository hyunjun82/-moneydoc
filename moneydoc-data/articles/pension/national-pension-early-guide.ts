...
<p class="v2-lead"><span class="v2-ans">연금을 미루면 1개월마다 0.6%씩 늘어요. 5년을 미루면 1,360,000원이 돼요.</span> 조기수령이 1년에 6%씩 깎는 것과 반대로, 연기연금은 1개월 0.6%가 열두 달 쌓여요. 정상수령액이 100만원이면 5년 연기로 360,000원이 더해져요. 소득이 있고 건강하다면 미루는 쪽이 유리할 수 있어요.</p>
...
export const landing = {
  "hero": {
    ...
    "line1": "국민연금 조기수령 감액",
    "line2": "언제가 유리한가",
    "sub1": "정상 100만원 → 60세 수령 시 700,000원",
    "sub2": "손익분기는 약 76.7세예요",
    "foot": "국민연금법 조기노령연금 지급률과 일치 · 2026-09-02 검증",
    "card": {
      "label": "60세 조기수령액",
      "big": "700,000",
      "unit": "원",
  ...
  "boxes": [
    {
      "title": "1년에 6%씩 깎여요",
      "text": "최대 5년까지 당길 수 있고 30%가 최대 감액이에요. 평생 그 금액으로 받아요"
    },
    {
      "title": "오래 살수록 불리해요",
      "text": "60세부터 받으면 손익분기가 약 76.7세라 그보다 오래 살면 손해예요"
    }
  ],
  "keyPoints": {
    "title": "한눈에 보는 조기수령",
    "rows": [
      ...
      [
        "소득 요건",
        "소득이 있는 업무에 종사하지 않아야 조기 신청이 가능해요"
      ],
      [
        "손익분기",
        "60세 시작이면 약 76.7세"
      ...
      [
        "연기연금",
        "1개월 미룰 때마다 0.6%씩 늘어 5년이면 1,360,000원"
      ],
      [
        "되돌리기",
        "조기수령을 시작하면 원칙적으로 되돌릴 수 없어요"
      ]
    ]
  },
  "sections": [
    {
      "id": "s1",
      "h2": "국민연금 조기수령 감액, 얼마나 깎이나요",
      "sub": "1년에 6%씩 평생 줄어요"
    },
    {
      "id": "s2",
      "h2": "조기노령연금 조건은 어떻게 되나요",
      "sub": "가입 10년과 소득 요건을 봐요"
    },
    {
      "id": "s3",
      "h2": "조기수령 손익분기점, 몇 살인가요",
      "sub": "먼저 받은 총액과 나중 총액이 같아지는 시점"
    },
    {
      "id": "s4",
      "h2": "연기연금과 비교하면 어느 쪽이 낫나요",
      "sub": "미루면 1개월에 0.6%씩 늘어요"
    },
    {
      "id": "s5",
      "h2": "조기연금 소득 있으면 어떻게 되나요",
      "sub": "60세부터 65세 사이에는 감액될 수 있어요"
    }
  ],
  "faq": [
    {
      "q": "국민연금 조기수령하면 얼마나 깎이나요?",
      "a": "1년에 6%씩 깎여요. 5년 일찍 받으면 30%가 줄어 정상 100만원이 <b>700,000원</b>이 돼요."
    },
    {
      "q": "조기노령연금 조건이 뭔가요?",
      "a": "가입 기간이 10년 이상이고 소득이 있는 업무에 종사하지 않아야 해요. 정상 개시보다 최대 5년 일찍 받을 수 있어요."
    },
    {
      "q": "조기수령 손익분기는 몇 살인가요?",
      "a": "60세부터 받으면 약 76.7세예요. 그보다 오래 살면 정상수령이 유리해요."
    },
    {
      "q": "연기연금은 얼마나 늘어나나요?",
      "a": "1개월 미룰 때마다 0.6%씩 늘어요. 5년을 미루면 360,000원이 더해져 1,360,000원이 돼요."
    },
    {
      "q": "조기수령을 다시 되돌릴 수 있나요?",
      "a": "원칙적으로 어려워요. 한 번 정해진 감액률이 평생 이어지니 신중하게 결정해야 해요."
    },
    {
      "q": "소득이 있으면 연금이 깎이나요?",
      "a": "60세부터 65세 사이에는 초과소득월액에 따라 줄어요. 빼는 금액은 연금액의 절반을 넘지 않고, 65세가 지나면 감액하지 않아요."
    },
    {
      "q": "정상 수령 나이가 몇 살인가요?",
      "a": "출생 연도에 따라 달라요. 1969년 이후 출생자는 65세부터예요."
    }
  ],
  "related": [
    {
