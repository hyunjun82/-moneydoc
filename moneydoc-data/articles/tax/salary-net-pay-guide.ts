...
<div class="v2-meta"><span>글 한결</span><span>·</span><span>2026년 9월 기준</span><span>·</span><span>8분</span><span class="v2-badge">홈택스 간이세액표 원 단위 일치 · 2026-09-09</span></div>
...
<section class="v2-kk" aria-label="한눈에 보는 요약">
  ...
  <dl>
    ...
    <div class="v2-row"><dt>검증</dt><dd>홈택스 간이세액표 조회값과 원 단위 일치 (2026-09-09)</dd></div>
  </dl>
</section>
...
<b>정부 도구</b>홈택스 근로소득 간이세액표 조회값과 5케이스 원 단위 일치 (2026-09-09). 4대보험은 공단 요율로 계산해 4대사회보험 정보연계센터 모의계산과 대조했어요.
</div>
...
export const landing = {
  "hero": {
    ...
    "foot": "국세청 간이세액표 원본 · 홈택스 조회값과 일치 · 2026-09-09 검증",
    "card": {
      "label": "월 실수령액",
      "big": "3,522,740",
      "unit": "원",
  ...
  "badge": "홈택스 간이세액표 원 단위 일치 · 2026-09-09",
  "basis": "2026년 9월 기준",
  "readMinutes": 8,
  "quick": [
    {
  ...
  "keyPoints": {
    ...
    "rows": [
      ...
      [
        "검증",
        "홈택스 간이세액표 조회값과 원 단위 일치 (2026-09-09)"
      ]
    ]
  },
  "sections": [
