...
<div class="v2-meta"><span>MoneyDoc 편집팀</span><span>·</span><span>2026년 9월 기준</span><span>·</span><span>8분</span><span class="v2-badge">홈택스 간이세액표 원 단위 일치 · 2026-09-03</span></div>
...
<section class="v2-kk" aria-label="한눈에 보는 요약">
  ...
  <dl>
    ...
    <div class="v2-row"><dt>검증</dt><dd>홈택스 간이세액표 조회값과 원 단위 일치 (2026-09-03)</dd></div>
  </dl>
</section>
...
<h2 id="s5">연봉 실수령액을 늘리려면 어떻게 하나요 (부양가족·비과세 식대)<small>세전 급여를 못 바꿀 때 손댈 수 있는 두 가지</small></h2>
...
<b>정부 도구</b>홈택스 근로소득 간이세액표 조회값과 5케이스 원 단위 일치 (2026-09-03). 4대보험은 공단 요율로 계산해 4대사회보험 정보연계센터 모의계산과 대조했어요.
</div>
...
export const landing = {
  "hero": {
    ...
    "line1": "2026년 연봉",
    "line2": "실수령액 표",
    "sub1": "연봉 5,000만원 → 월 3,522,740원 (공제율 15.5%)",
    "sub2": "국민연금 4.75% · 건강보험 3.595% · 고용보험 0.9% · 간이세액표 2026.3",
    "foot": "국세청 간이세액표 원본 · 홈택스 조회값과 일치 · 2026-09-03 검증",
    "card": {
      "label": "월 실수령액",
      "big": "3,522,740",
      "unit": "원",
    ...
    "alt": "2026년 연봉 실수령액 표. 연봉 5,000만원이면 월 3,522,740원, 1억이면 월 6,471,100원"
  },
  "calc": {
    "href": "/salary/calculator/",
    "label": "연봉 실수령액 계산기 바로가기"
  },
  "badge": "홈택스 간이세액표 원 단위 일치 · 2026-09-03",
  "basis": "2026년 9월 기준",
  "readMinutes": 8,
  "quick": [
    {
      ...
      "big": "2,217,910원",
      "unit": "월 실수령",
      "sub": "공제율 11.3% · 4대보험 242,930원 · 소득세+지방세 39,160원",
      "selected": false
    },
    {
      "chip": "4,000만",
      "big": "2,893,710원",
      "unit": "월 실수령",
      "sub": "공제율 13.2% · 4대보험 323,890원 · 소득세+지방세 115,730원",
      "selected": false
    },
    {
      "chip": "5,000만",
      "big": "3,522,740원",
      "unit": "월 실수령",
      "sub": "공제율 15.5% · 4대보험 404,870원 · 소득세+지방세 239,050원",
      "selected": true
    },
    {
      "chip": "7,000만",
      "big": "4,771,000원",
      "unit": "월 실수령",
      "sub": "공제율 18.2% · 4대보험 566,820원 · 소득세+지방세 495,510원",
      "selected": false
    },
    {
      "chip": "1억",
      "big": "6,471,100원",
      "unit": "월 실수령",
      "sub": "공제율 22.3% · 4대보험 726,950원 · 소득세+지방세 1,135,280원",
      "selected": false
    }
  ],
  "boxes": [
    {
      "title": "4대보험이 월 404,870원 빠져요",
      "text": "연봉 5,000만원 기준. 국민연금 197,910원, 건강보험 149,790원, 장기요양 19,680원, 고용보험 37,490원"
    },
    {
      "title": "세금은 월 239,050원이에요",
      "text": "소득세 217,320원 + 지방소득세 21,730원. 부양가족이 늘면 줄어요"
    }
  ],
  "keyPoints": {
    ...
    "rows": [
      [
        "기준",
        "2026년 9월 · 본인 1명 · 비과세 0원 · 국세청 2026.3 간이세액표"
      ],
      [
        "연봉 5,000만",
        "월 3,522,740원 (공제율 15.5%)"
      ],
      [
        "연봉 1억",
        "월 6,471,100원 (공제율 22.3%)"
      ],
      [
        "4대보험 요율",
        "국민연금 4.75% · 건강보험 3.595% · 장기요양 0.4724% · 고용보험 0.9%"
      ],
      [
        "국민연금 상한",
        "월 급여 659만원 (연봉 약 7,908만원) 초과분은 더 안 늘어요"
      ],
      [
        "실수령 늘리기",
        "부양가족 신고 · 비과세 식대 월 20만원 (월 48,810원 차이)"
      ],
      [
        "2025년 대비",
        "국민연금 근로자 요율 4.5% → 4.75%, 연봉 5,000만원이면 월 10,420원 더 빠져요"
      ],
      [
        "검증",
        "홈택스 간이세액표 조회값과 원 단위 일치 (2026-09-03)"
      ]
    ]
  },
  "sections": [
    {
      "id": "s1",
      "h2": "연봉 실수령액 계산 방법, 월급에서 뭐가 빠지나요",
      "sub": "연봉 5,000만원 = 월 세전 4,166,666원 기준"
    },
    {
      "id": "s2",
      "h2": "2026년 연봉 실수령액 표, 연봉 3000·4000·5000·7000·1억은 월 얼마인가요",
      "sub": "2,400만원부터 2억까지 · 본인 1명 · 비과세 0원"
    },
    {
      "id": "s3",
      "h2": "2026년 4대보험 요율, 월급에서 얼마나 떼나요",
      "sub": "요율은 법으로 정해져 있어 회사가 달라도 같아요"
    },
    {
      "id": "s4",
      "h2": "연봉 100만원 인상되면 실수령액은 얼마나 늘어나나요",
      "sub": "연봉 협상은 세후로 계산해야 해요"
    },
    {
      "id": "s5",
      "h2": "연봉 실수령액을 늘리려면 어떻게 하나요 (부양가족·비과세 식대)",
      "sub": "세전 급여를 못 바꿀 때 손댈 수 있는 두 가지"
    },
    {
      "id": "s6",
      "h2": "급여명세서 실수령액이 계산과 다른 이유는 무엇인가요",
      "sub": "차이가 난다면 이 다섯 가지 중 하나예요"
    },
    {
      "id": "s7",
      "h2": "월급 실수령액이 매달 다른 이유는 무엇인가요 (1월·4월·7월)",
      "sub": "같은 연봉인데 어떤 달은 다르게 들어오는 이유"
    }
  ],
  "faq": [
    {
      "q": "연봉 5000 실수령액은 월 얼마인가요?",
      "a": "부양가족 본인 1명, 비과세 0원 기준 월 <b>3,522,740원</b>이에요. 세전 4,166,666원에서 4대보험 404,870원, 소득세·지방소득세 239,050원이 빠져 공제율 15.5%예요. 홈택스 간이세액표 조회값과 같은 숫자예요."
    },
    {
      "q": "연봉 1억이면 실수령액은 얼마인가요?",
      "a": "월 <b>6,471,100원</b>, 공제율 22.3%예요. 5,000만원의 실수령 3,522,740원과 비교하면 세전은 2배지만 실수령은 1.84배예요."
    },
    {
      "q": "2026년에 실수령액이 줄어든 이유가 뭔가요?",
      "a": "국민연금 요율이 총 9%에서 9.5%로 올라 근로자 몫이 4.5%에서 4.75%가 됐어요. 연봉 5,000만원이면 국민연금만 월 10,420원 더 내요. 소득세는 2026년 3월 간이세액표 개정으로 따로 바뀌었어요."
    },
    {
      "q": "회사 명세서 소득세가 이 글과 다른데 왜 그런가요?",
      "a": "다섯 가지를 확인하세요. 비과세 식대(월 20만원)가 급여에 포함돼 있는지, 부양가족 신고 인원, 회사가 80%·120% 원천징수 비율을 적용했는지, 상여가 있는 달인지, 4월 건보 정산·7월 국민연금 상한 변경 달인지예요."
    },
    {
      "q": "월 실수령액으로 연봉을 거꾸로 알 수 있나요?",
      "a": "공제율이 연봉마다 달라 단순 나눗셈은 틀려요. 위 표에서 실수령액이 가까운 줄을 찾거나, 연봉 실수령액 계산기의 \"실수령액 → 연봉\" 기능을 쓰면 정확해요."
    },
    {
      "q": "소득세는 매달 이렇게 확정되는 건가요?",
      "a": "아니에요. 매달 빠지는 소득세는 간이세액표에 따른 선납이고, 다음 해 1~2월 연말정산에서 실제 세액과 정산해 환급받거나 더 내요. 이 글의 숫자는 매달 통장에 들어오는 금액 기준이에요."
    }
  ],
  "related": [
    {
    ...
    {
      "kind": "세금 가이드",
      "label": "2026 4대보험 요율, 회사 부담까지",
      "href": "/four-insurance/"
    },
    {
      "kind": "세금 가이드",
      "label": "종합소득세 계산, 세율 구간",
      "href": "/income-tax/"
    }
  ]
};
