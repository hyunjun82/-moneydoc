  ...
  ['ws','wy','wo'].forEach(function(id){document.getElementById(id).addEventListener('input',wrender)}); wrender();`,
      ...
      { id: 's6', h2: '실업급여 받다가 취업하면, 알바하면 어떻게 되나요', sub: '일찍 취업하면 남은 돈의 절반을 보너스로, 알바는 신고하면 돼요', blocks: [
        ...
        { type: 'tips', items: [
          ...
          { title: '실업급여 받는 동안 건강보험', text: '지역가입자로 바뀌어요. 보험료가 오르면 "임의계속가입"으로 직장 보험료 수준을 최대 36개월 유지할 수 있어요. 조건은 직장가입 1년 이상, 신청 기한은 지역가입자 첫 보험료 고지서의 납부기한부터 2개월 안이에요.' },
    ...
    faq: [
      ...
      ['실업급여 받는 동안 4대보험은 어떻게 되나요?', '직장 건강보험은 퇴사와 함께 지역가입자로 바뀌어요. 보험료가 부담되면 "임의계속가입"으로 직장 보험료 수준을 최대 36개월 유지할 수 있어요. 조건은 직장가입 1년 이상이에요. 신청은 지역가입자 첫 보험료 납부기한부터 2개월 안에 해야 해요. 국민연금은 실업크레딧으로 보험료의 75%를 지원받을 수 있어요.'],
    ],
    summary: [
