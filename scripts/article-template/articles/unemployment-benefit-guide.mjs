...
export default function article({ calculators, loadSpec, VERIFIED, derive = (v) => v }) {
  ...
  return {
    ...
    sections: [
      { id: 's1', h2: '실업급여 조건, 나도 받을 수 있나요 (수급자격 판정)', sub: '세 가지만 맞으면 받을 수 있어요', blocks: [
        ...
        { type: 'h3', id: 'reasons', text: '자발적 퇴사인데 실업급여를 받는 경우는 언제인가요' },
  ...
  ['ws','wy','wo'].forEach(function(id){document.getElementById(id).addEventListener('input',wrender)}); wrender();`,
      ...
      { id: 's5', h2: '실업급여 신청 방법은 어떻게 되나요 (이직확인서부터 첫 지급까지)', sub: '퇴사 다음 날부터 12개월 안에 다 받아야 하니 바로 시작하세요', blocks: [
        { type: 'p', lead: true, ans: '이직확인서 확인, 워크넷 구직등록, 고용센터 수급자격 신청, 4주마다 실업인정. 이 네 단계예요.', text: '첫 돈은 보통 신청 후 2~3주 뒤에 들어와요.' },
        { type: 'steps', items: [
          { title: '이직확인서 확인', text: '회사가 고용보험에 제출해요. 고용24에서 처리됐는지 확인하고, 안 냈으면 회사에 요청하세요(요청받은 날부터 10일 내 제출 의무)', meta: '준비물: 없음 · 퇴사 후 바로', link: { label: '이직확인서 확인', href: 'https://www.work24.go.kr/cm/f/c/0100/selectUnifySearch.do?topQuerySearchArea=all&topQueryData=%EC%9D%B4%EC%A7%81%ED%99%95%EC%9D%B8%EC%84%9C' } },
      ...
      { id: 's5b', h2: '실업급여 구직활동 몇 번 해야 하나요 (실업인정 회차별 기준)', sub: '회차마다 해야 할 일이 달라요. 1차와 4차는 고용센터에 직접 가야 해요', blocks: [
        ...
        { type: 'table', text: true, caption: '반복·장기 수급자와 60세 이상은 재취업활동 기준이 달라요', headers: ['수급자 유형', '강화된 기준'], rows: [
          { cells: ['반복 수급자', '2차부터 구직활동만 인정, 4차부터 4주에 2회'] },
          { cells: ['장기 수급자', '5~7차 4주에 2회(구직활동 1회 포함), 8차부터 1주에 1회 구직활동만'] },
