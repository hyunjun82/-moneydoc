...
function mdSalary(annual, dependents, kids, nontaxable){
  ...
  ['wa','wd','wk','wn'].forEach(function(id){document.getElementById(id).addEventListener('input',wrender)}); wrender();`,
      ...
      { id: 's7', h2: '월급 실수령액이 매달 다른 이유는 무엇인가요 (1월·4월·7월)', sub: '같은 연봉인데 어떤 달은 다르게 들어오는 이유', blocks: [
        ...
        { type: 'table', text: true, caption: '월급 실수령액이 달라지는 달과 이유', headers: ['시기', '무엇이 바뀌나', '금액 방향'], rows: [
          { cells: ['1~2월', '연말정산으로 전년 소득세 확정', '환급 또는 추가 납부'] },
          { cells: ['3월', '간이세액표 개정분 반영', '소득세 변동'] },
          { cells: ['4월', '전년 보수 기준 건강보험 정산', '연봉 올랐으면 추가 납부'] },
          { cells: ['7월', `국민연금 기준소득월액 상·하한 변경 (상한 ${man(C.NP_CAP_MONTHLY)}원)`, '고소득자는 국민연금 증가'] },
        ], fn: '이 네 달은 같은 연봉이어도 실수령액이 달라져요. 나머지 달은 대체로 같은 금액이 들어와요.' },
      ] },
    ],
    faq: [
