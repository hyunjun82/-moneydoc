  ...
  ['pm','pl'].forEach(function(id){document.getElementById(id).addEventListener('input',plrender)}); plrender();`,
      ...
      { id: 's4', h2: '육아휴직 급여 신청 방법은 어떻게 되나요', sub: '고용보험 홈페이지나 고용센터', blocks: [
        ...
        { type: 'steps', items: [
          ...
          { title: '지급', text: '심사를 거쳐 계좌로 입금돼요. 금액을 미리 확인해 두면 좋아요', meta: '보통 2주 안', link: { label: '육아휴직 급여 계산기', href: '/parental-leave/calculator/' } },
        ] },
    ...
    related: [
      { kind: '계산기', label: '육아휴직 급여 계산기', href: '/parental-leave/calculator/' },
